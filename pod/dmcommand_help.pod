=head1 Crossfire TRT Dungeon Master Commands
...
This will cause a Crossfire TRT server to shut down entirely by first
kicking out all players, saving all maps and finally exiting. Crossfire
