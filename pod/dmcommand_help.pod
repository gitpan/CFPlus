...
This will NOT reset any per-player maps, such as apartments, or remove
unique items or items on unique floors. I.e. it works exactly as if the
map reached its reset time prematurely.
